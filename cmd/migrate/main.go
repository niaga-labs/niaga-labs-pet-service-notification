// Command migrate applies the SQL migrations in ./migrations to the notification
// database and exits.
//
...
import (
	...
	svcconfig "github.com/niaga-labs/niaga-labs-pet-service-notification/internal/config"
	"go.uber.org/zap"
)
...
func main() {
	...
	zapLogger, err := logger.NewNamed(cfg.AppEnv, "service-notification-migrate")
	if err != nil {
